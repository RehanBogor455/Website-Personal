...
<div class="col-lg-8">
    ...
    <?php if($filter): ?>
        <div class="h3 mb-3"><?php echo e($filter_name); ?> - <span class="text-primary"><?php echo e($filter); ?></span></div>
    <?php endif; ?>
    <!-- Featured blog post-->
    ...
    <?php else: ?>
        <h3 class="my-2"><i class="fa-solid fa-magnifying-glass"></i>Tidak ada artikel ditemukan</h3>
    <?php endif; ?>
    <!-- Pagination-->
...
<?php echo $__env->make('blog.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\evvnxx_blg\resources\views/blog/artikel.blade.php ENDPATH**/ ?>