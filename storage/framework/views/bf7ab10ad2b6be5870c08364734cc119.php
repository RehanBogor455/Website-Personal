    ...
    <div class="card mt-3">
        <div class="card-body px-4">
            <div class="d-flex justify-content-between col-lg">
                <h1 class="mt-2 mb-4 text-center">Edit Artikel</h1>
            ...
            <div class="col-lg">
                ...
                <?php elseif($errors->any()): ?>
                    <div class="alert alert-danger"><?php echo e('Edit Artikel Gagal..'); ?></div>
                <?php endif; ?>

                <form action="/dashboard/artikel/<?php echo e($data->id); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="judul" name="judul" value="<?php echo e(old('judul', $data->judul)); ?>" onkeyup="getSlug()">
...
unset($__errorArgs, $__bag); ?>>
                            ...
                            <?php if(old('category_id', $data->category_id) == $category->id): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($data->gambar): ?>
                            <img src="<?php echo e(asset('images/' . $data->gambar)); ?>" class="img-fluid tampil-gambar mb-3 d-block" width="500px" alt="">
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" id="tokenfield" name="tag" value="<?php echo e('tag', $tags); ?>">
                        <?php $__errorArgs = ['tag'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        <textarea name="isi" class="form-control" id="editor"><?php echo e(old('isi', $data->isi)); ?></textarea>
                    </div>
...
<?php echo $__env->make('dashboard.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\evvnxx_blg\resources\views/dashboard/artikel/artikel-edit.blade.php ENDPATH**/ ?>