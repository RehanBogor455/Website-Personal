    ...
    <div class="card mt-3">
        <div class="card-body px-4">
            <div class="d-flex justify-content-between col-lg">
                <h1 class="mt-2 mb-4 text-center">Kategori Baru</h1>
            ...
            <div class="col-lg">
                ...
                <?php elseif($errors->any()): ?>
                    <div class="alert alert-danger"><?php echo e('Input Kategori Gagal..'); ?></div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" id="kategori" name="nama" value="<?php echo e(old('nama')); ?>" onkeyup="getSlug()">
...
<?php echo $__env->make('dashboard.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\evvnxx_blg\resources\views/dashboard/kategori/kategori-baru.blade.php ENDPATH**/ ?>